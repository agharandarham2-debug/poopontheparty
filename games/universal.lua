...
run(function()
	-- Privacy-safe whitelist shim:
	-- Removed original-owner whitelist/blacklist updater, original-owner HTTP requests,
	-- remote uninject/blacklist kick logic, private-member chat signaling, and remote command handling.
	...
	-- Keep the old update loop shape, but it no longer contacts any external service.
	task.spawn(function()
		repeat
			whitelist:update(whitelist.loaded)
			task.wait(10)
